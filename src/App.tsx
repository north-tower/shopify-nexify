      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/seller/orders" element={<SellerRoute element={<SellerOrders />} />} />
            <Route path="/seller/analytics" element={<SellerRoute element={<SellerAnalytics />} />} />
            <Route path="/seller/settings" element={<SellerRoute element={<SellerSettings />} />} />
            <Route 
              path="/seller/account" 
